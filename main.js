...
`) + `	Complement Sets cannot be automatically optimized.
	...
	See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#COMPLEMENT for details.`);
      ...
      e && (i = `
	This will disable the lexer's first char optimizations.
	See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#REGEXP_PARSING for details.`), Ur(xn + `
    ...
    case "Alternative":
      for (var i = t.value, r = 0; r < i.length; r++) {
        ...
        if (
          ...
          c.type === "Group" && _r(c) === !1 || // If this term is not a group it may only be optional if it has an optional quantifier
          c.type !== "Group" && h === !1
        )
          break;
      }
...
function _r(t) {
  return t.quantifier && t.quantifier.atLeast === 0 ? !0 : t.value ? ot(t.value) ? We(t.value, _r) : _r(t.value) : !1;
}
var Dc = (
  /** @class */
  function(t) {
...
}(), at = "PATTERN", Lt = "defaultMode", An = "modes", Jo = typeof new RegExp("(?:)").sticky == "boolean";
function Vc(t, e) {
  e = $r(e, {
    useSticky: Jo,
    debug: !1,
...
`],
  ...
  n("Line Terminator Handling", function() {
    var A = ts(e.lineTerminatorCharacters);
    s = x(r, function(m) {
      return !1;
      ...
      if (es(m, A) === !1)
        return Hr(A, m.PATTERN);
    }));
  });
  var l, f, v, d;
  n("Misc Mapping #2", function() {
    l = x(r, jo), f = x(a, sl), v = Ne(r, function(A, m) {
      var N = m.GROUP;
      return st(N) && N !== Qe.SKIPPED && (A[N] = []), A;
    }, {}), d = x(a, function(A, m) {
      return {
        pattern: a[m],
        longerAlt: p[m],
  ...
  return e.safeMode || n("First Char Optimization", function() {
    E = Ne(r, function(A, m, N) {
      if (typeof m.PATTERN == "string") {
        ...
        gr(A, R, d[N]);
      } else if (ot(m.START_CHARS_HINT)) {
        var T;
        V(m.START_CHARS_HINT, function(C) {
          var M = typeof C == "string" ? C.charCodeAt(0) : C, _ = Tt(M);
          T !== _ && (T = _, gr(A, _, d[N]));
        });
      } else if (dt(m.PATTERN))
        if (m.PATTERN.unicode)
          g = !1, e.ensureOptimizations && Ur("" + xn + ("	Unable to analyze < " + m.PATTERN.toString() + ` > pattern.
`) + `	The regexp unicode flag is not currently supported by the regexp-to-ast library.
	This will disable the lexer's first char optimizations.
	For details See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#UNICODE_OPTIMIZE`);
        else {
          var w = Fc(m.PATTERN, e.ensureOptimizations);
          ee(w) && (g = !1), V(w, function(C) {
            gr(A, C, d[N]);
          });
        }
      else
        e.ensureOptimizations && Ur("" + xn + ("	TokenType: <" + m.name + `> is using a custom token pattern without providing <start_chars_hint> parameter.
`) + `	This will disable the lexer's first char optimizations.
...
function Gc(t, e) {
  var n = [], r = Hc(t);
  n = n.concat(r.errors);
  var i = Wc(r.valid), a = i.valid;
  return n = n.concat(i.errors), n = n.concat($c(a)), n = n.concat(Jc(a)), n = n.concat(jc(a, e)), n = n.concat(el(a)), n;
}
function $c(t) {
  var e = [], n = je(t, function(r) {
    return dt(r[at]);
  });
  return e = e.concat(Yc(n)), e = e.concat(Xc(n)), e = e.concat(Qc(n)), e = e.concat(Zc(n)), e = e.concat(Kc(n)), e;
}
function Hc(t) {
...
function Zc(t) {
  var e = [], n = x(t, function(a) {
    return Ne(t, function(c, h) {
      return a.PATTERN.source === h.PATTERN.source && !fe(e, h) && h.PATTERN !== Qe.NA && (e.push(h), c.push(h)), c;
    }, []);
  });
  n = sn(n);
...
function Jc(t) {
  var e = je(t, function(r) {
    if (!$(r, "GROUP"))
      return !1;
    var i = r.GROUP;
    return i !== Qe.SKIPPED && i !== Qe.NA && !st(i);
  }), n = x(e, function(r) {
    return {
...
function el(t) {
  var e = [], n = Ne(t, function(r, i, a) {
    var c = i.PATTERN;
    return c === Qe.NA || (st(c) ? r.push({ str: c, idx: a, tokenType: i }) : dt(c) && nl(c) && r.push({ str: c.source, idx: a, tokenType: i })), r;
  }, []);
  return V(t, function(r, i) {
    V(n, function(a) {
      var c = a.str, h = a.idx, p = a.tokenType;
      if (i < h && tl(c, r.PATTERN)) {
...
function il(t, e, n) {
  var r = [], i = !1, a = sn(Ge(Oc(t.modes, function(p) {
    return p;
  }))), c = Ht(a, function(p) {
    return p[at] === Qe.NA;
  }), h = ts(n);
  return e && V(c, function(p) {
    ...
    if (u !== !1) {
      ...
      $(p, "LINE_BREAKS") ? p.LINE_BREAKS === !0 && (i = !0) : Hr(h, p.PATTERN) && (i = !0);
  }), e && !i && r.push({
...
function sl(t) {
  return st(t) && t.length === 1 ? t.charCodeAt(0) : !1;
}
var al = {
  // implements /\n|\r\n?/g.test
  test: function(t) {
...
function ts(t) {
  var e = x(t, function(n) {
    return st(n) && n.length > 0 ? n.charCodeAt(0) : n;
  });
  return e;
}
function gr(t, e, n) {
...
function fl(t) {
  V(t, function(e) {
    is(e) || (ns[Ci] = e, e.tokenTypeIdx = Ci++), Ii(e) && !ot(e.CATEGORIES) && (e.CATEGORIES = [e.CATEGORIES]), Ii(e) || (e.CATEGORIES = []), dl(e) || (e.categoryMatches = []), vl(e) || (e.categoryMatchesMap = {});
  });
}
function hl(t) {
  V(t, function(e) {
    e.categoryMatches = [], V(e.categoryMatchesMap, function(n, r) {
      e.categoryMatches.push(ns[r].tokenTypeIdx);
    });
  });
}
function pl(t) {
...
a boolean 2nd argument is no longer supported`);
      ...
      i === !0 ? (this.traceInitMaxIdent = 1 / 0, this.traceInitPerf = !0) : typeof i == "number" && (this.traceInitMaxIdent = i, this.traceInitPerf = !0), this.traceInitIndent = -1, this.TRACE_INIT("Lexer Constructor", function() {
        ...
        r.TRACE_INIT("Lexer Config handling", function() {
          if (r.config.lineTerminatorsPattern === jt.lineTerminatorsPattern)
            r.config.lineTerminatorsPattern = al;
	...
	For details See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#MISSING_LINE_TERM_CHARS`);
          ...
          r.trackStartLines = /full|onlyStart/i.test(r.config.positionTracking), r.trackEndLines = /full/i.test(r.config.positionTracking), ot(e) ? (a = { modes: {} }, a.modes[Lt] = Se(e), a[Lt] = Lt) : (c = !1, a = on(e));
        }), r.config.skipValidations === !1 && (r.TRACE_INIT("performRuntimeChecks", function() {
          r.lexerDefinitionErrors = r.lexerDefinitionErrors.concat(rl(a, r.trackStartLines, r.config.lineTerminatorCharacters));
        }), r.TRACE_INIT("performWarningRuntimeChecks", function() {
          r.lexerDefinitionWarning = r.lexerDefinitionWarning.concat(il(a, r.trackStartLines, r.config.lineTerminatorCharacters));
        ...
        if (V(a.modes, function(o, s) {
          r.TRACE_INIT("Mode: <" + s + "> processing", function() {
            if (r.modes.push(s), r.config.skipValidations === !1 && r.TRACE_INIT("validatePatterns", function() {
              r.lexerDefinitionErrors = r.lexerDefinitionErrors.concat(Gc(o, h));
...
` + u);
        ...
        V(r.lexerDefinitionWarning, function(o) {
          ...
          if (Jo ? (r.chopInput = Ni, r.match = r.matchWithTest) : (r.updateLastIndex = de, r.match = r.matchWithExec), c && (r.handleModes = de), r.trackStartLines === !1 && (r.computeNewColumn = Ni), r.trackEndLines === !1 && (r.updateTokenEndLineColumnLocation = de), /full/i.test(r.config.positionTracking))
...
` + i);
      ...
      var r = this, i, a, c, h, p, u, o, s, l, f, v, d, g, E, A = e, m = A.length, N = 0, y = 0, R = this.hasCustom ? 0 : Math.floor(e.length / 10), T = new Array(R), w = [], C = this.trackStartLines ? 1 : void 0, M = this.trackStartLines ? 1 : void 0, _ = ol(this.emptyGroups), W = this.trackStartLines, F = this.config.lineTerminatorsPattern, S = 0, G = [], J = [], le = [], nt = [];
      Object.freeze(nt);
      var Ae = void 0;
      function Be() {
        return G;
      ...
      for (var ue; N < m; ) {
        p = null;
        var Et = A.charCodeAt(N), Bt = Ae(Et), mt = Bt.length;
        for (i = 0; i < mt; i++) {
          ue = Bt[i];
          var Rt = ue.pattern;
          u = null;
          var qt = ue.short;
          if (qt !== !1 ? Et === qt && (p = Rt) : ue.isCustom === !0 ? (E = Rt.exec(A, N, T, _), E !== null ? (p = E[0], E.payload !== void 0 && (u = E.payload)) : p = null) : (this.updateLastIndex(Rt, N), p = this.match(Rt, e, N)), p !== null) {
        ...
        if (p !== null) {
          ...
          this.handleModes(ue, rt, Ee, v);
        } else {
          for (var rr = N, ti = C, ni = M, Yt = !1; !Yt && N < m; )
            for (A.charCodeAt(N), e = this.chopInput(e, 1), N++, a = 0; a < S; a++) {
              var ir = G[a], Rt = ir.pattern, qt = ir.short;
              if (qt !== !1 ? A.charCodeAt(N) === qt && (Yt = !0) : ir.isCustom === !0 ? Yt = Rt.exec(A, N, T, _) !== null : (this.updateLastIndex(Rt, N), Yt = Rt.exec(e) !== null), Yt === !0)
                break;
            }
          d = N - rr, g = this.config.errorMessageProvider.buildUnexpectedCharactersMessage(A, rr, d, ti, ni), w.push({
            offset: rr,
            line: ti,
            column: ni,
            length: d,
      ...
      if (this.traceInitPerf === !0) {
        ...
        var i = zo(n), a = i.time, c = i.value, h = a > 10 ? console.warn : console.log;
...
function Pt(t) {
  return ss(t) ? t.LABEL : t.name;
}
function El(t) {
  return t.name;
}
function ss(t) {
  return st(t.LABEL) && t.LABEL !== "";
}
var ml = "parent", Oi = "categories", Mi = "label", Ui = "group", Li = "push_mode", _i = "pop_mode", Pi = "longer_alt", ki = "line_breaks", xi = "start_chars_hint";
function Wr(t) {
  return Rl(t);
}
function Rl(t) {
  var e = t.pattern, n = {};
  if (n.name = t.name, pt(e) || (n.PATTERN = e), $(t, ml))
...
var wt = Wr({ name: "EOF", pattern: Qe.NA });
cn([wt]);
...
var gt = globalThis && globalThis.__extends || function() {
  ...
  function(t) {
    ...
    function e(n) {
      var r = t.call(this, []) || this;
      return r.idx = 1, tt(r, et(n, function(i) {
        return i !== void 0;
      })), r;
    }
  ...
  function(t) {
    ...
    function e(n) {
      ...
      return r.orgText = "", tt(r, et(n, function(i) {
        return i !== void 0;
      })), r;
    }
    return e;
  ...
  function(t) {
    ...
    function e(n) {
      var r = t.call(this, n.definition) || this;
      return r.ignoreAmbiguities = !1, tt(r, et(n, function(i) {
        return i !== void 0;
      })), r;
    }
    return e;
  ...
  function(t) {
    ...
    function e(n) {
      var r = t.call(this, n.definition) || this;
      return r.idx = 1, r.ignoreAmbiguities = !1, r.hasPredicates = !1, tt(r, et(n, function(i) {
        return i !== void 0;
      })), r;
    }
    return Object.defineProperty(e.prototype, "definition", {
  ...
  function() {
    function t(e) {
      this.idx = 1, tt(this, et(e, function(n) {
        return n !== void 0;
      }));
    }
...
function en(t) {
  ...
  if (t instanceof ne) {
    ...
    return t.terminalType.PATTERN && (n.pattern = dt(r) ? r.source : r), n;
  } else {
    if (t instanceof kt)
      return {
        type: "Rule",
...
), Al = globalThis && globalThis.__extends || function() {
  var t = function(e, n) {
    return t = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(r, i) {
      r.__proto__ = i;
    } || function(r, i) {
...
function yl(t) {
  return t instanceof Te || t instanceof ye || t instanceof ce || t instanceof qe || t instanceof Ye || t instanceof $e || t instanceof ne || t instanceof kt;
}
function Bn(t, e) {
  e === void 0 && (e = []);
  var n = t instanceof ye || t instanceof ce || t instanceof $e;
  return n ? !0 : t instanceof He ? qo(t.definition, function(r) {
    return Bn(r, e);
  }) : t instanceof Ue && fe(e, t) ? !1 : t instanceof ct ? (t instanceof Ue && e.push(t), We(t.definition, function(r) {
    return Bn(r, e);
  })) : !1;
}
function Tl(t) {
...
var ls = "_~IN~_", Ml = globalThis && globalThis.__extends || function() {
  var t = function(e, n) {
    return t = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(r, i) {
      r.__proto__ = i;
    } || function(r, i) {
  ...
  function(t) {
    ...
    return e.prototype.startWalking = function() {
      ...
      var a = _l(n.referencedRule, n.idx) + this.topProd.name, c = r.concat(i), h = new Te({ definition: c }), p = ln(h);
      this.follows[a] = p;
    }, e;
  }(Yn)
);
...
var qr = {
  buildMismatchTokenMessage: function(t) {
    ...
    var r = ss(e), i = r ? "--> " + Pt(e) + " <--" : "token of type --> " + e.name + " <--", a = "Expecting " + i + " but found --> '" + n.image + "' <--";
    return a;
  },
  ...
  buildNoViableAltMessage: function(t) {
    ...
    t.ruleName;
    var i = "Expecting: ", a = Je(n).image, c = `
but found: '` + a + "'";
    if (r)
      return i + r + c;
...
inside top level rule: ->` + t.name + "<-";
  ...
  buildDuplicateFoundError: function(t, e) {
    ...
    var r = t.name, i = Je(e), a = i.idx, c = it(i), h = n(i), p = a > 0, u = "->" + c + (p ? a : "") + "<- " + (h ? "with argument: ->" + h + "<-" : "") + `
...
}, Pl = globalThis && globalThis.__extends || function() {
  var t = function(e, n) {
    return t = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(r, i) {
      r.__proto__ = i;
    } || function(r, i) {
...
var hs = globalThis && globalThis.__extends || function() {
  var t = function(e, n) {
    return t = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(r, i) {
      r.__proto__ = i;
    } || function(r, i) {
...
function Gl(t, e, n, r, i, a) {
  var c = Yr(t, e, n), h = vs(c) ? Sn : Wn;
  return a(c, r, h, i);
}
function $l(t, e, n, r, i, a) {
  var c = Kr(t, e, i, n), h = vs(c) ? Sn : Wn;
  return a(c[0], h, r);
}
function Hl(t, e, n, r) {
  var i = t.length, a = We(t, function(p) {
    return We(p, function(u) {
      return u.length === 1;
    });
  });
  if (e)
  ...
  for (var n = x(t, function(o) {
    ...
    for (var p = function(o) {
      for (var s = h[o], l = 0; l < s.length; l++) {
        var f = s[l].partialPath, v = s[l].suffixDef, d = Er(f), g = Yl(i, d, o);
...
function Yr(t, e, n, r) {
  var i = new ps(t, j.ALTERNATION, r);
  return e.accept(i), ds(i.result, n);
}
function Kr(t, e, n, r) {
  var i = new ps(t, n);
  e.accept(i);
  var a = i.result, c = new ql(e, t, n), h = c.startWalking(), p = new Te({ definition: a }), u = new Te({ definition: h });
  return ds([p, u], r);
}
function kr(t, e) {
  e:
...
function Kl(t, e) {
  return t.length < e.length && We(t, function(n, r) {
    var i = e[r];
...
var zr = globalThis && globalThis.__extends || function() {
  var t = function(e, n) {
    return t = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(r, i) {
      r.__proto__ = i;
    } || function(r, i) {
...
function zl(t, e, n, r, i) {
  ...
  We(c, ee) && (h = x(t, function(f) {
    return eu(f, r);
  }), p = x(t, function(f) {
    return tu(f, e, r);
  }), u = iu(t, e, r));
  var o = au(t, n, r), s = x(t, function(f) {
    return ru(f, r);
  }), l = x(t, function(f) {
    return Jl(f, t, i, r);
  });
  return Ge(a.concat(u, c, h, p, o, s, l));
}
function Xl(t, e) {
  var n = new Zl();
  t.accept(n);
  var r = n.allProductions, i = _c(r, Ql), a = et(i, function(h) {
    return h.length > 1;
  }), c = x(xe(a), function(h) {
    var p = Je(h), u = e.buildDuplicateFoundError(t, h), o = it(p), s = {
      message: u,
...
function Ql(t) {
  return it(t) + "_#_" + t.idx + "_#_" + gs(t);
}
function gs(t) {
...
function Es(t, e, n, r) {
  ...
  var p = $n(a, r.concat([t])), u = x(p, function(o) {
    var s = Se(r);
    return s.push(o), Es(t, o, n, s);
  });
  return i.concat(Ge(u));
}
function Mn(t) {
  var e = [];
  if (ee(t))
  ...
  else if (n instanceof Te || n instanceof ye || n instanceof qe || n instanceof Ye || n instanceof $e || n instanceof ce)
    e = e.concat(Mn(n.definition));
  else if (n instanceof He)
    e = Ge(x(n.definition, function(c) {
...
function tu(t, e, n) {
  ...
  var a = Ne(i, function(c, h) {
    var p = h.idx, u = h.maxLookahead || e, o = Yr(p, t, u, h), s = ou(o, h, t, n), l = su(o, h, t, n);
    return c.concat(s, l);
  }, []);
  return a;
}
...
function iu(t, e, n) {
  ...
  return V(t, function(i) {
    ...
    V(c, function(h) {
      var p = Vl(h), u = h.maxLookahead || e, o = h.idx, s = Kr(o, i, p, u), l = s[0];
      if (ee(Ge(l))) {
...
function ou(t, e, n, r) {
  var i = [], a = Ne(t, function(h, p, u) {
    return e.definition[u].ignoreAmbiguities === !0 || V(p, function(o) {
      var s = [u];
      V(t, function(l, f) {
        u !== f && kr(l, o) && // ignore (skip) ambiguities with this "other" alternative
        e.definition[f].ignoreAmbiguities !== !0 && s.push(f);
      }), s.length > 1 && !kr(i, o) && (i.push(o), h.push({
        alts: s,
        path: o
      }));
    }), h;
...
function su(t, e, n, r) {
  ...
  return V(a, function(c) {
    ...
    if (h.ignoreAmbiguities !== !0) {
      var p = c.idx, u = c.path, o = Mc(a, function(l) {
        return (
...
function ms(t) {
  ...
  return V(t.rules, function(n) {
    e[n.name] = n;
  }), kl(e, t.errMsgProvider);
}
function Rs(t) {
  return t = $r(t, {
    errMsgProvider: Kn
  }), zl(t.rules, t.maxLookahead, t.tokenTypes, t.errMsgProvider, t.grammarName);
}
function cu(t) {
...
}(), Ns = "MismatchedTokenException", As = "NoViableAltException", ys = "EarlyExitException", Ts = "NotAllInputParsedException", ws = [
  Ns,
  As,
  ys,
  Ts
...
var Xn = (
  ...
  function(t) {
    ...
    function e(n, r, i) {
      ...
      return a.previousToken = i, a.name = Ns, a;
    }
    return e;
  }(Xn)
), Cs = (
  ...
  function(t) {
    ...
    function e(n, r, i) {
      var a = t.call(this, n, r) || this;
      return a.previousToken = i, a.name = As, a;
    }
    return e;
  }(Xn)
), Is = (
  ...
  function(t) {
    ...
    function e(n, r, i) {
      var a = t.call(this, n, r) || this;
      return a.previousToken = i, a.name = ys, a;
    }
    return e;
  }(Xn)
), mr = {}, Ms = "InRuleRecoveryException";
function Us(t) {
  this.name = Ms, this.message = t;
}
...
var lu = (
  ...
  function() {
    ...
    return t.prototype.initRecoverable = function(e) {
      this.firstAfterRepMap = {}, this.resyncFollows = {}, this.recoveryEnabled = $(e, "recoveryEnabled") ? e.recoveryEnabled : vt.recoveryEnabled, this.recoveryEnabled && (this.attemptInRepetitionRecovery = uu);
      ...
      if (e === mr)
        return [wt];
      var n = e.ruleName + e.idxInCallingRule + ls + e.inRule;
...
var fu = 4, It = 8, Ls = 1 << It, _s = 2 << It, xr = 3 << It, Sr = 4 << It, Br = 5 << It, Un = 6 << It;
function Rr(t, e, n) {
  return n | e | t;
}
var hu = (
  ...
  function() {
    ...
    return t.prototype.initLooksAhead = function(e) {
      this.dynamicTokensEnabled = $(e, "dynamicTokensEnabled") ? e.dynamicTokensEnabled : vt.dynamicTokensEnabled, this.maxLookahead = $(e, "maxLookahead") ? e.maxLookahead : vt.maxLookahead, this.lookAheadFuncsCache = Ai() ? /* @__PURE__ */ new Map() : [], Ai() ? (this.getLaFuncFromCache = this.getLaFuncFromMap, this.setLaFuncCache = this.setLaFuncCacheUsingMap) : (this.getLaFuncFromCache = this.getLaFuncFromObj, this.setLaFuncCache = this.setLaFuncUsingObj);
    }, t.prototype.preComputeLookaheadFunctions = function(e) {
      var n = this;
      V(e, function(r) {
        n.TRACE_INIT(r.name + " Rule Lookahead", function() {
          var i = wl(r), a = i.alternation, c = i.repetition, h = i.option, p = i.repetitionMandatory, u = i.repetitionMandatoryWithSeparator, o = i.repetitionWithSeparator;
          V(a, function(s) {
            var l = s.idx === 0 ? "" : s.idx;
            n.TRACE_INIT("" + it(s) + l, function() {
              var f = Gl(s.idx, r, s.maxLookahead || n.maxLookahead, s.hasPredicates, n.dynamicTokensEnabled, n.lookAheadBuilderForAlternatives), v = Rr(n.fullRuleNameToShort[r.name], Ls, s.idx);
              n.setLaFuncCache(v, f);
            });
          }), V(c, function(s) {
            n.computeLookaheadFunc(r, s.idx, xr, j.REPETITION, s.maxLookahead, it(s));
          }), V(h, function(s) {
            n.computeLookaheadFunc(r, s.idx, _s, j.OPTION, s.maxLookahead, it(s));
          }), V(p, function(s) {
            n.computeLookaheadFunc(r, s.idx, Sr, j.REPETITION_MANDATORY, s.maxLookahead, it(s));
          }), V(u, function(s) {
            n.computeLookaheadFunc(r, s.idx, Un, j.REPETITION_MANDATORY_WITH_SEPARATOR, s.maxLookahead, it(s));
          }), V(o, function(s) {
            n.computeLookaheadFunc(r, s.idx, Br, j.REPETITION_WITH_SEPARATOR, s.maxLookahead, it(s));
          });
        });
      });
      ...
      this.TRACE_INIT("" + c + (n === 0 ? "" : n), function() {
        var p = $l(n, e, a || h.maxLookahead, h.dynamicTokensEnabled, i, h.lookAheadBuilderForOptional), u = Rr(h.fullRuleNameToShort[e.name], r, n);
...
function Ps(t, e) {
  ...
  return pt(n) || n.configurable ? (Object.defineProperty(t, Gi, {
    enumerable: !1,
    configurable: !0,
    writable: !1,
    value: e
...
function gu(t, e) {
  for (var n = Ze(t), r = n.length, i = 0; i < r; i++)
...
function mu(t, e, n) {
  ...
  Ps(r, t + "BaseSemanticsWithDefaults");
...
var Au = ["constructor", "visit", "validateVisitor"];
function yu(t, e) {
  var n = [];
  for (var r in t)
    Ct(t[r]) && !fe(Au, r) && !fe(e, r) && n.push({
...
var Tu = (
  ...
  function() {
    ...
    return t.prototype.initTreeBuilder = function(e) {
      if (this.CST_STACK = [], this.outputCst = e.outputCst, this.nodeLocationTracking = $(e, "nodeLocationTracking") ? e.nodeLocationTracking : vt.nodeLocationTracking, !this.outputCst)
      ...
      pu(r, n, e), this.setNodeLocationFromToken(r.location, n);
    }, t.prototype.cstPostNonTerminal = function(e, n) {
      var r = this.CST_STACK[this.CST_STACK.length - 1];
      du(r, n, e), this.setNodeLocationFromNode(r.location, e.location);
    }, t.prototype.getBaseCstVisitorConstructor = function() {
      if (pt(this.baseCstVisitorConstructor)) {
        var e = Eu(this.className, Ze(this.gastProductionsCache));
        return this.baseCstVisitorConstructor = e, e;
      }
      return this.baseCstVisitorConstructor;
    }, t.prototype.getBaseCstVisitorConstructorWithDefaults = function() {
      if (pt(this.baseCstVisitorWithDefaultsConstructor)) {
        var e = mu(this.className, Ze(this.gastProductionsCache), this.getBaseCstVisitorConstructor());
  ...
  function() {
    ...
    return t.prototype.ACTION = function(e) {
      ...
      r === void 0 && (r = Vn);
      var i = [];
      i = i.concat(jl(e, this.definedRulesNames, this.className)), this.definitionErrors.push.apply(this.definitionErrors, i);
      ...
      return as(xe(this.gastProductionsCache));
    }, t;
  }()
), Iu = (
  /** @class */
  function() {
    ...
    return t.prototype.initRecognizerEngine = function(e, n) {
      if (this.className = vu(this), this.shortRuleNameToFull = {}, this.fullRuleNameToShort = {}, this.ruleShortNameIdx = 256, this.tokenMatcher = Sn, this.definedRulesNames = [], this.tokensMap = {}, this.isBackTrackingStack = [], this.RULE_STACK = [], this.RULE_OCCURRENCE_STACK = [], this.gastProductionsCache = {}, $(n, "serializedGrammar"))
	...
	For Further details.`);
      ...
      else if ($(e, "modes") && We(Ge(xe(e.modes)), gl)) {
        var r = Ge(xe(e.modes)), i = Vr(r);
...
Make sure that all grammar rule definitions are done before 'performSelfAnalysis' is called.`);
      var i = $(r, "resyncEnabled") ? r.resyncEnabled : Vn.resyncEnabled, a = $(r, "recoveryValueFunc") ? r.recoveryValueFunc : Vn.recoveryValueFunc, c = this.ruleShortNameIdx << fu + It;
      ...
      var r = this.getKeyForAutomaticLookahead(_s, n);
      ...
      this.attemptInRepetitionRecovery(this.atLeastOneInternal, [e, n], a, Sr, e, bl);
      ...
      var r = this.getKeyForAutomaticLookahead(Br, e);
      ...
      var r = this.getKeyForAutomaticLookahead(Ls, n), i = ot(e) ? e : e.DEF, a = this.getLaFuncFromCache(r), c = a.call(this, i);
      if (c !== void 0) {
        var h = i[c];
  ...
  function() {
    ...
    return t.prototype.initErrorHandler = function(e) {
      this._errors = [], this.errorMessageProvider = $(e, "errorMessageProvider") ? e.errorMessageProvider : vt.errorMessageProvider;
      ...
      for (var i = this.getCurrRuleFullName(), a = this.getGAstProductions()[i], c = Kr(e, a, n, this.maxLookahead), h = c[0], p = [], u = 1; u <= this.maxLookahead; u++)
        p.push(this.LA(u));
      ...
      throw this.SAVE_ERROR(new Os(o, this.LA(1), this.LA(0)));
    }, t.prototype.raiseNoAltException = function(e, n) {
      for (var r = this.getCurrRuleFullName(), i = this.getGAstProductions()[r], a = Yr(e, i, this.maxLookahead), c = [], h = 1; h <= this.maxLookahead; h++)
        c.push(this.LA(h));
      ...
      throw this.SAVE_ERROR(new Cs(u, this.LA(1), p));
    }, t;
  }()
), Mu = (
  /** @class */
  function() {
    ...
    return t.prototype.initContentAssist = function() {
      ...
      return fs([r], n, this.tokenMatcher, this.maxLookahead);
    }, t.prototype.getNextPossibleTokenTypes = function(e) {
      var n = Je(e.ruleStack), r = this.getGAstProductions(), i = r[n], a = new Bl(i, e).startWalking();
      return a;
    }, t;
  }()
), Zn = {
...
Object.freeze(Zn);
var $i = !0, Hi = Math.pow(2, It) - 1, ks = Wr({ name: "RECORDING_PHASE_TOKEN", pattern: Qe.NA });
cn([ks]);
var xs = qn(
  ks,
...
var Uu = {
 ...
 inside top level rule: <` + this.recordingProdStack[0].name + ">"));
      ...
      return a.definition.push(h), this.outputCst ? Uu : Zn;
...
), Ss = globalThis && globalThis.__extends || function() {
  var t = function(e, n) {
    return t = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(r, i) {
      r.__proto__ = i;
    } || function(r, i) {
...
var Zr = (
  ...
  function() {
	...
	For further details.`);
      this.skipValidations = $(n, "skipValidations") ? n.skipValidations : vt.skipValidations;
    }
    return t.performSelfAnalysis = function(e) {
      ...
      this.TRACE_INIT("performSelfAnalysis", function() {
        ...
        if (e.TRACE_INIT("Grammar Resolving", function() {
          ...
          var a = Ll(xe(e.gastProductionsCache));
          e.resyncFollows = a;
...
function Bu(t, e) {
  var n = e === void 0 ? {} : e, r = n.resourceBase, i = r === void 0 ? "https://unpkg.com/chevrotain@" + Mr + "/diagrams/" : r, a = n.css, c = a === void 0 ? "https://unpkg.com/chevrotain@" + Mr + "/diagrams/diagrams.css" : a, h = `
...
function Ku(t) {
  return Fu({ name: t.name, rules: t.rules });
}
function zu() {
...
const Qu = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  EMPTY_ALT: ku,
  EOF: wt,
  EarlyExitException: Os,
  EmbeddedActionsParser: Su,
  GAstVisitor: xt,
  Lexer: Qe,
  get LexerDefinitionErrorType() {
    return se;
  },
  MismatchedTokenException: Qr,
  NoViableAltException: Cs,
  NonTerminal: Ue,
  NotAllInputParsedException: Is,
  Option: ye,
  Parser: Xu,
  ...
  Repetition: ce,
  RepetitionMandatory: qe,
  RepetitionMandatoryWithSeparator: Ye,
  RepetitionWithSeparator: $e,
  Rule: kt,
  Terminal: ne,
  VERSION: Mr,
  assignOccurrenceIndices: cu,
  clearCache: zu,
  createSyntaxDiagramsCode: Bu,
  createToken: Wr,
  createTokenInstance: qn,
  defaultGrammarResolverErrorProvider: us,
  defaultGrammarValidatorErrorProvider: Kn,
  defaultLexerErrorProvider: os,
  defaultParserErrorProvider: qr,
  generateParserFactory: Yu,
  generateParserModule: Ku,
  ...
  tokenName: El,
  validateGrammar: Rs
}, Symbol.toStringTag, { value: "Module" })), Jr = /* @__PURE__ */ fa(Qu), { createToken: z, Lexer: Fs } = Jr, Zu = he(), bs = {}, Ju = z({
  name: "WhiteSpace",
  pattern: /\s+/,
  group: Fs.SKIPPED
}), ju = z({
...
const Rf = z({
  ...
  Uf,
  Lf
], xf = new Fs(Ds, { ensureOptimizations: !0 });
Ds.forEach((t) => {
  bs[t.name] = t;
});
var ei = {
...
` + n.message, n.errorLocation = { line: r, column: i }, Zu.ERROR(n.message, n);
    }
    return e;
  }
};
const Vs = ei, { EmbeddedActionsParser: Sf } = Jr, Bf = Vs.tokenVocabulary, {
  String: Ki,
  SheetQuoted: Ff,
  ExcelRefFunction: Vh,
  ExcelConditionalRefFunction: Gh,
  Function: bf,
  FormulaErrorT: zi,
  RefError: Xi,
  Cell: Df,
...
class oh extends Sf {
  ...
  constructor(e, n) {
    ...
    r.RULE("formulaWithBinaryOp", () => {
      ...
      return r.MANY(() => {
        r.CONSUME(Hf), a.push(r.SUBRULE2(r.formula));
      ...
      const i = [[]];
      let a = 0;
      return r.CONSUME(Yf), i[a].push(r.SUBRULE(r.constantForArray)), r.MANY(() => {
        const c = r.OR([
          { ALT: () => r.CONSUME(Tn).image },
          { ALT: () => r.CONSUME(Wf).image }
        ]), h = r.SUBRULE2(r.constantForArray);
        c === "," || (a++, i[a] = []), i[a].push(h);
      }), r.CONSUME(Kf), r.ACTION(() => this.utils.toArray(i));
      ...
      const i = r.CONSUME(bf).image.slice(0, -1), a = r.SUBRULE(r.arguments);
      ...
      { ALT: () => r.CONSUME(Vf).image.slice(0, -1) },
      { ALT: () => r.CONSUME(Ff).image.slice(1, -2).replace(/''/g, "'") }
...
const Qt = he(), { Address: sh } = ge(), { Prefix: ah, Postfix: ch, Infix: yr, Operators: Tr } = Dr, lh = Gn, ji = 1048576, eo = 16384, { NotAllInputParsedException: uh } = Jr;
let fh = class {
  constructor(e) {
    this.context = e;
  }
  columnNameToNumber(e) {
    return sh.columnNameToNumber(e);
  }
  /**
  ...
  _applyPrefix(e, n, r) {
    return this.isFormulaError(n) ? n : ah.unaryOp(e, n, r);
  }
  ...
  _applyPostfix(e, n, r) {
    return this.isFormulaError(e) ? e : ch.percentOp(e, r, n);
  }
  ...
  static formatChevrotainError(e, n) {
    let r, i, a = "";
    return e instanceof uh ? (r = e.token.startLine, i = e.token.startColumn) : (r = e.previousToken.startLine, i = e.previousToken.startColumn + 1), a += `
` + n.split(`
`)[r - 1] + `
...
var $s = fh;
const hh = So, to = bo, no = Sa, ro = ba, io = qa, oo = Xa, so = ec, ao = cc, co = Nc, ph = Ic, be = he(), { FormulaHelpers: Ut } = ge(), { Parser: dh, allTokens: vh } = Gs, lo = ei, wr = $s;
let gh = class {
  /**
  ...
  constructor(e, n = !1) {
    this.logs = [], this.isTest = n, this.utils = new wr(this), e = Object.assign({
      ...
      "CHOOSE",
      "WEBSERVICE"
    ], this.funsPreserveRef = Object.keys(so), this.parser = new dh(this, this.utils);
  }
  /**
...
const wn = he(), { FormulaHelpers: Wh, Types: qh, Address: mh } = ge(), Rh = Gn, uo = 1048576, fo = 16384;
let Nh = class {
  constructor(e) {
    this.context = e;
  }
  columnNameToNumber(e) {
    return mh.columnNameToNumber(e);
  }
  /**
   * Parse the cell address only.
   * @param {string} cellAddress
...
var Ah = Nh;
const ho = he(), { FormulaHelpers: Cr } = ge(), { Parser: yh } = Gs, Th = ei, po = Ah, { formatChevrotainError: wh } = $s;
let Ch = class {
  /**
   *
  ...
  constructor(e) {
    this.data = [], this.utils = new po(this), e = Object.assign({
      onVariable: () => null
    }, e), this.utils = new po(this), this.onVariable = e.onVariable, this.functions = {}, this.parser = new yh(this, this.utils);
  }
  /**
   * Get value from the cell reference
   * @param ref
...
const { FormulaParser: Hs } = Eh, { DepParser: Oh } = Ih, Mh = _o, Uh = he();
Object.assign(Hs, {
  MAX_ROW: 1048576,
  MAX_COLUMN: 16384,
  SSF: Mh,
...
var Ws = Hs;
const Lh = /* @__PURE__ */ ua(Ws);
class _h {
  constructor(e) {
    U(this, "parser");
    U(this, "depParser");
    U(this, "root");
    this.root = e, this.parser = new Lh({
      onCell: ({ col: n, row: r }) => {
    ...
    }), this.depParser = new Ws.DepParser({}), this.depParser;
  }
}
const Wt = "modern_sc_";
class zh {
  constructor(e, n) {
    ...
    const r = mo(40, 40), i = this.makeConfigFromData(r, (n == null ? void 0 : n.view) ?? { height: 600, width: 800 });
    n != null && n.view && (i.view = n.view), this.config = new Ir(i), this.config.onCellClick = (n == null ? void 0 : n.onCellClick) ?? null, this.config.onSelectonChange = (n == null ? void 0 : n.onSelectionChange) ?? null, this.config.onCellChange = (n == null ? void 0 : n.onCellChange) ?? null, this.config.onCopy = (n == null ? void 0 : n.onCopy) ?? null, this.rowsBar = new ca(this), this.columnsBar = new aa(this), this.sheet = new js(this), this.table = new ea(this), this.scroller = new Qs(this), this.toolbar = new ta(this), this.editor = new Xs(this), this.cache = this.getInitialCache(), this.viewport = new ii(this, this.scroller.getViewportBoundlingRect()), this.selection = new br(), this.events = new zs(this), this.clipboard = new la(this), this.formulaParser = new _h(this), this.data = r, this.styles = new na(), this.buildComponent(), this.setElementsPositions(), this.appendTableToTarget(e), this.renderSheet(), this.renderColumnsBar(), this.renderRowsBar();
  }
  setRowsBarPosition() {
  ...
  appendTableToTarget(e) {
    if (typeof e == "string") {
      ...
      if (!n)
        throw new Error(`Element with selector ${e} is not finded in DOM.
 Make sure it exists.`);
...
export {
  ...
  Eo as Row,
  br as Selection,
  Js as SerializableCell,
  na as Styles,
  ii as Viewport,
  ra as createSampleConfig,
  mo as createSampleData,
  zh as default,
  Bh as makeSpreadsheetConfigAndData
};
